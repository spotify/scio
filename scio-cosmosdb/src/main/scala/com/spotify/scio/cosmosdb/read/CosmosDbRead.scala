...
private[read] case class CosmosDbRead(private[cosmosdb] val endpoint: String = null,
                        private[cosmosdb] val key: String = null,
                        private[cosmosdb] val database: String = null,
                        private[cosmosdb] val container: String = null,
                        private[cosmosdb] val query: String = null)
