 ...
 */
class CassandraSCollectionOps[T](@transient private val self: SCollection[T]) extends AnyVal {
...
trait SCollectionSyntax {
  implicit def cassandraSCollectionOps[T](sc: SCollection[T]): CassandraSCollectionOps[T] =
    new CassandraSCollectionOps[T](sc)
}
