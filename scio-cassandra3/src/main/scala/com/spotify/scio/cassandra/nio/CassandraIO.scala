...
import com.spotify.scio.cassandra
import com.spotify.scio.cassandra.{CassandraOptions, BulkOperations}
import com.spotify.scio.nio.ScioIO
import com.spotify.scio.io.Tap
import scala.concurrent.Future

final case class Cassandra[T](opts: CassandraOptions, parallelism: Int = 0)(f: T => Seq[Any])
  extends ScioIO[T] {

  type ReadP = Nothing
  type WriteP = Unit

  def id: String = cassandra.CassandraIO(opts).uniqueId
