 ...
 *
 * <p>By default, the pipeline will do fixed windowing, on 1-minute windows. You can change this
 * interval by setting the {@code --windowSize} parameter, e.g. {@code --windowSize=10} for
 * 10-minute windows.
 *
...
public class WindowedWordCount {
  ...
  static class AddTimestampFn extends DoFn<String, String> {
    ...
    public void processElement(@Element String element, OutputReceiver<String> out) {
      ...
      out.outputWithTimestamp(element, new Instant(randomTimestamp));
    }
  }
  ...
  static void runWindowedWordCount(Options options) throws IOException {
    ...
    /**
     * Concept #1: the Beam SDK lets us run the same pipeline with either a bounded or unbounded
     * input source.
     */
    ...
    /**
     * Concept #4: Re-use our existing CountWords transform that does not have knowledge of windows
     * over a PCollection containing windowed values.
     */
     ...
     * idempotent, but the details of writing to files is elided here.
     */
    wordCounts
