...
public class DebuggingWordCount {
  ...
  public static class FilterTextFn extends DoFn<KV<String, Long>, KV<String, Long>> {
    ...
    public void processElement(
        ...
        OutputReceiver<KV<String, Long>> outputReceiver) {
  ...
  static void runDebuggingWordCount(WordCountOptions options) {
    ...
    /**
     * Concept #3: PAssert is a set of convenient PTransforms in the style of Hamcrest's collection
     * matchers that can be used when writing Pipeline level tests to validate the contents of
     * PCollections. PAssert is best used in unit tests with small data sets but is demonstrated
     * here as a teaching tool.
     *
     * <p>Below we verify that the set of filtered words matches our expected counts. Note that
     * PAssert does not provide any output and that successful completion of the Pipeline implies
     * that the expectations were met. Learn more at
     * https://beam.apache.org/documentation/pipelines/test-your-pipeline/ on how to test your
     * Pipeline and see {@link DebuggingWordCountTest} for an example unit test.
     */
