...
<p style="background-color: #fce8e6; padding: 10px; color:red; font-weight:bold">RUN THIS BEFORE UPGRADING SCIO</p>
...
You can see all the rules [here](https://github.com/spotify/scio/tree/master/scalafix/rules/src/main/scala/fix).
...
A complete list of IO packages can be found [here](https://github.com/spotify/scio/wiki/ScioIO).
...
<p style="background-color: #fce8e6; padding: 10px; color:red">
Before implementing custom coders, we recommend that you test your pipeline with the default coders. Implementing custom coders can be tricky, so make sure there's a clear benefit in doing it
</p>

If you want to implement custom coders, see Scio's source code for [examples](https://github.com/spotify/scio/tree/master/scio-core/src/main/scala/com/spotify/scio/coders/instances).

<p style="background-color: #fce8e6; padding: 10px; color:red">
If you implement custom Coders, you need to make sure they are  Serializable
</p>
