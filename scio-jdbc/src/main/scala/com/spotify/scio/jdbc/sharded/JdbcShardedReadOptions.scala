 ...
 * @param shardColumn
 *   Column to shard by. Should ideally have evenly distributed values. Must have a corresponding
 *   [[com.spotify.scio.jdbc.sharded.Shard]] implementation for the column type.
 * @param rowMapper
