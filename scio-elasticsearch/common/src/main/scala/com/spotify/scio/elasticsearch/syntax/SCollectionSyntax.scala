...
package com.spotify.scio.elasticsearch.syntax
...
class ElasticsearchSCollectionOps[T](@transient private val self: SCollection[T]) extends AnyVal {
...
trait SCollectionSyntax {
  implicit def elasticsearchSCollectionOps[T](sc: SCollection[T]): ElasticsearchSCollectionOps[T] =
    new ElasticsearchSCollectionOps[T](sc)
}
