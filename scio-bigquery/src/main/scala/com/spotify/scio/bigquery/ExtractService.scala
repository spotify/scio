...
private[scio] class ExtractService(private val projectId: String,
  ...
  def asJson(sourceTable: String, destinationUris: List[String],
  ...
  def asAvro(sourceTable: String, destinationUris: List[String],
             gzipCompression: Boolean = false): Unit = {
  ...
  private def execute(sourceTable: String,
