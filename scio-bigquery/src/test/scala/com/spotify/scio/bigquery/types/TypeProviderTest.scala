...
class TypeProviderTest extends FlatSpec with Matchers {
  ...
  it should "support .fromTableRow in companion object with more than 22 fields" in {
    (classOf[(TableRow => TwentyThree)] isAssignableFrom TwentyThree.fromTableRow.getClass) shouldBe true
  }

  it should "support .toTableRow in companion object with more than 22 fields" in {
