...
public class ExampleParquetInputFormat extends ParquetInputFormat<Example> {
    ...
    /**
     * Set the subset of columns to read (projection pushdown). Specified as an tensorflow
     ...
     * <p>
     * If a requested projection is set, then the tensorflow schema used for reading
     * must be compatible with the projection. Use {@link #setExampleReadSchema(org.apache.hadoop.mapreduce.Job,
     * org.tensorflow.metadata.v0.Schema)} to set a read schema, if needed.
     *
     * @param job                 a job
     ...
     * @see com.spotify.scio.parquet.tensorflow.ExampleParquetOutputFormat#setSchema(org.apache.hadoop.mapreduce.Job, org.tensorflow.metadata.v0.Schema)
     */
    public static void setRequestedProjection(Job job, Schema requestedProjection) {
        ExampleReadSupport.setRequestedProjection(ContextUtil.getConfiguration(job),
                requestedProjection);
    }
     ...
     * @see #setRequestedProjection(org.apache.hadoop.mapreduce.Job, org.tensorflow.metadata.v0.Schema)
     * @see com.spotify.scio.parquet.tensorflow.ExampleParquetOutputFormat#setSchema(org.apache.hadoop.mapreduce.Job, org.tensorflow.metadata.v0.Schema)
     */
