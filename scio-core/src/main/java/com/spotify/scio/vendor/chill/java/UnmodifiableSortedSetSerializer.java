...
/**
 * A kryo {@link Serializer} for unmodifiable sortable sets created via {@link
...
public class UnmodifiableSortedSetSerializer
    extends UnmodifiableJavaCollectionSerializer<SortedSet<?>> {

  @SuppressWarnings("unchecked")
  public static IKryoRegistrar registrar() {
    return new SingleRegistrar(
        Collections.unmodifiableSortedSet(new TreeSet(Collections.EMPTY_SET)).getClass(),
