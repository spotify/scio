...
/**
 * A kryo {@link Serializer} for unmodifiable collections created via {@link
...
public class UnmodifiableCollectionSerializer
    extends UnmodifiableJavaCollectionSerializer<Collection<?>> {

  @SuppressWarnings("unchecked")
  public static IKryoRegistrar registrar() {
    return new SingleRegistrar(
        Collections.unmodifiableCollection(Collections.EMPTY_SET).getClass(),
