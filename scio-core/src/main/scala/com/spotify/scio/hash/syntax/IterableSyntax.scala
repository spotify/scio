...
class ApproxFilterIterableOps[T](private val self: Iterable[T]) extends AnyVal {
...
trait IterableSyntax {
  implicit def approxFilterIterableOps[T](xs: Iterable[T]): ApproxFilterIterableOps[T] =
    new ApproxFilterIterableOps[T](xs)
}
