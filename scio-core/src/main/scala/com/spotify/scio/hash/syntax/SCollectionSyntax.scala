...
class ApproxFilterSCollectionOps[T](private val self: SCollection[T]) extends AnyVal {
...
trait SCollectionSyntax {
  implicit def approxFilterSCollectionOps[T](self: SCollection[T]): ApproxFilterSCollectionOps[T] =
    new ApproxFilterSCollectionOps(self)
}
