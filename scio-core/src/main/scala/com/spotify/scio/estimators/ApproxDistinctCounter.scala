 ...
 * distinct count per each key in a key-value SCollection.
 *
 * @tparam T
 */
...
/**
 * ApproxDistinctCounter impl for [[org.apache.beam.sdk.transforms.ApproximateUnique]] with sample
 * size.
 *
...
/**
 * ApproxDistinctCounter impl for [[org.apache.beam.sdk.transforms.ApproximateUnique]] with maximum
 * estimation error.
 *
