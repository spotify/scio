...
final case class Append[T](key: T, value: T, ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
final case class Set[T](key: T, value: T, ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
final case class IncrBy[T](key: T, value: Long, ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
final case class DecrBy[T](key: T, value: Long, ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
final case class SAdd[T](key: T, value: Seq[T], ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
final case class LPush[T](key: T, value: Seq[T], ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
final case class RPush[T](key: T, value: Seq[T], ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
final case class PFAdd[T](key: T, value: Seq[T], ttl: Option[Duration] = None)(
  implicit
  val rt: RedisType[T]
) extends RedisMutation
