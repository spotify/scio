...
object RollupTest {
  ...
  implicit val uag: Group[(Long, Long)] = caseclass.group
...
class RollupTest extends PipelineSpec {
  ...
  "RollupAndCount" should "work with empty input" in {
    ...
    val input = Seq[(String, FixedDims, RollupDims1D, MsPlayed, (Long, Long))]()

    runWithData(input)(_.rollupAndCount(groupingSets, (1L, 1L))) should contain theSameElementsAs Seq()
  }

  it should "not double-count a user with multiple values of rollup dimensions" in {

    val input = Seq(
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web")), MsPlayed(100L), (1L, 1L)),
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile")), MsPlayed(200L), (1L, 1L))
    )

    val expected = Seq(
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web"))), (MsPlayed(100L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile"))), (MsPlayed(200L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(None)), (MsPlayed(300L), (1L, 1L)))
    )

    runWithData(input)(_.rollupAndCount(groupingSets, (1L, 1L))) should contain theSameElementsAs expected
  }
  ...
  it should "correctly sum users on top-level even if they are active in different cohorts" in {
    ...
    val input = Seq(
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web")), MsPlayed(100L), (1L, 1L)),
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile")), MsPlayed(200L), (1L, 1L)),
      ("user2", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("speaker")), MsPlayed(200L), (1L, 1L))
    )

    val expected = Seq(
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web"))), (MsPlayed(100L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile"))), (MsPlayed(200L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("speaker"))), (MsPlayed(200L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(None)), (MsPlayed(500L), (2L, 2L)))
    )
  ...
  it should "correctly separate on fixed dimensions and not sum users with the same rolllup " +
    ...
    val input = Seq(
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web")), MsPlayed(100L), (1L, 1L)),
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile")), MsPlayed(200L), (1L, 1L)),
      ("user2", FixedDims("2020-01-02", "sweden"), RollupDims1D(Some("speaker")), MsPlayed(200L),(1L, 1L))
    )

    val expected = Seq(
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web"))), (MsPlayed(100L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile"))), (MsPlayed(200L), (1L, 1L))),
      ((FixedDims("2020-01-02", "sweden"), RollupDims1D(Some("speaker"))), (MsPlayed(200L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(None)), (MsPlayed(300L), (1L, 1L))),
      ((FixedDims("2020-01-02", "sweden"), RollupDims1D(None)), (MsPlayed(200L), (1L, 1L)))
    )
  ...
  it should "correctly sum users on matching rolled up dimensions (android, total)" in {
    ...
    val expected = Seq(
      ...
      ((FixedDims("2020-01-01", "sweden"), RollupDims2D(Some("web"), None)), (MsPlayed(100L), (1L, 1L))),
      (
      ...
      ((FixedDims("2020-01-01", "sweden"), RollupDims2D(None, None)), (MsPlayed(600L), (2L, 2L)))
    )

    runWithData(input)(_.rollupAndCount(groupingSets, (1L, 1L))) should contain theSameElementsAs expected
  }

  // FIXME: This is actually testing new functionality
  it should "not double-count a user with multiple values of rollup dimensions, and not correct for 0 values" in {

    val input = Seq(
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web")), MsPlayed(100L), (1L, 1L)),
      ("user1", FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile")), MsPlayed(200L), (1L, 0L))
    )

    val expected = Seq(
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("web"))), (MsPlayed(100L), (1L, 1L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(Some("mobile"))), (MsPlayed(200L), (1L, 0L))),
      ((FixedDims("2020-01-01", "sweden"), RollupDims1D(None)), (MsPlayed(300L), (1L, 1L)))
    )
