...
public class PatchedBigtableIO {
  ...
  public static Read read() {
    return new AutoValue_PatchedBigtableIO_Read.Builder().setKeyRange(ByteKeyRange.ALL_KEYS).setTableId("")
        .build();
  }
  ...
  public static Write write() {
    return new AutoValue_PatchedBigtableIO_Write.Builder().setTableId("").build();
  }
  ...
  public abstract static class Read extends PTransform<PBegin, PCollection<Row>> {
    ...
    @Nullable
    abstract PatchedBigtableService getBigtableService();
    ...
    abstract static class Builder {
      ...
      abstract Builder setBigtableService(PatchedBigtableService bigtableService);
    ...
    public PCollection<Row> expand(PBegin input) {
      BigtableSource source =
          new BigtableSource(new SerializableFunction<PipelineOptions, PatchedBigtableService>() {
            @Override
            public PatchedBigtableService apply(PipelineOptions options) {
     ...
     * <p>Does not modify this object.
     */
    Read withBigtableService(PatchedBigtableService bigtableService) {
     ...
     */
    @VisibleForTesting
    PatchedBigtableService getBigtableService(PipelineOptions pipelineOptions) {
      ...
      return new PatchedBigtableServiceImpl(clonedOptions.build());
    }
  }
  ...
  static class BigtableSource extends BoundedSource<Row> {
    public BigtableSource(
        SerializableFunction<PipelineOptions, PatchedBigtableService> serviceFactory,
        String tableId,
    ...
    private final SerializableFunction<PipelineOptions, PatchedBigtableService> serviceFactory;
    private final String tableId;
  ...
  private static class BigtableReader extends BoundedReader<Row> {
    ...
    private PatchedBigtableService service;
    private PatchedBigtableService.Reader reader;
    private final ByteKeyRangeTracker rangeTracker;
    private long recordsReturned;

    public BigtableReader(BigtableSource source, PatchedBigtableService service) {
      this.source = source;
