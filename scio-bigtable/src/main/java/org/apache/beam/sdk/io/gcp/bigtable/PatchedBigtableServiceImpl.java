...
import org.apache.beam.sdk.io.gcp.bigtable.PatchedBigtableIO.BigtableSource;
 ...
 * service.
 */
class PatchedBigtableServiceImpl implements PatchedBigtableService {
  private static final Logger LOG = LoggerFactory.getLogger(BigtableService.class);

  public PatchedBigtableServiceImpl(BigtableOptions options) {
