...
public class BigtableIO {
  ...
  public abstract static class BulkWrite
    ...
    static BulkWrite create() {
      ...
      return new AutoValue_BigtableIO_BulkWrite.Builder().setBigtableConfig(config).build();
    }
    ...
    /**
     * Returns a new {@link BigtableIO.BulkWrite} that will write into the Cloud Bigtable project
     * indicated by given parameter, requires {@link #withInstanceId}
     * to be called to determine the instance.
     *
     * <p>Does not modify this object.
     */
    public BulkWrite withProjectId(ValueProvider<String> projectId) {
      BigtableConfig config = getBigtableConfig();
      return toBuilder().setBigtableConfig(config.withProjectId(projectId)).build();
    }
    ...
    /**
     * Returns a new {@link BigtableIO.BulkWrite} that will write into the Cloud Bigtable instance
     * indicated by given parameter, requires {@link #withProjectId} to be called to
     * determine the project.
     *
     * <p>Does not modify this object.
     */
    public BulkWrite withInstanceId(ValueProvider<String> instanceId) {
      BigtableConfig config = getBigtableConfig();
      return toBuilder().setBigtableConfig(config.withInstanceId(instanceId)).build();
    }
     ...
     * <p>Does not modify this object.
     */
    public BulkWrite withTableId(ValueProvider<String> tableId) {
      BigtableConfig config = getBigtableConfig();
      return toBuilder().setBigtableConfig(config.withTableId(tableId)).build();
    }
     ...
     * {@link #withInstanceId} and {@link #withProjectId} respectively.
     *
     * <p>Returns a new {@link BigtableIO.BulkWrite} that will write to the Cloud Bigtable instance
     * indicated by the given options, and using any other specified customizations.
     *
     * <p>Does not modify this object.
     *
    ...
    /**
     * Returns a new {@link BigtableIO.BulkWrite} that will read from the Cloud Bigtable instance
     * with customized options provided by given configurator.
     *
     * <p>WARNING: instanceId and projectId should not be provided here and should be provided over
     * {@link #withProjectId} and {@link #withInstanceId}.
     ...
     * <p>Does not modify this object.
     */
    public BulkWrite withBigtableOptionsConfigurator(
        SerializableFunction<BigtableOptions.Builder, BigtableOptions.Builder> configurator) {
      BigtableConfig config = getBigtableConfig();
      return toBuilder()
          .setBigtableConfig(config.withBigtableOptionsConfigurator(
    ...
    public PDone expand(PCollection<Iterable<KV<ByteString, Iterable<Mutation>>>> input) {
      ...
      input.apply(ParDo.of(new BigtableBulkWriterFn(getBigtableConfig())));
      return PDone.in(input.getPipeline());
    }
    ...
    private class BigtableBulkWriterFn extends DoFn<Iterable<KV<ByteString, Iterable<Mutation>>>, Void> {
      ...
      public BigtableBulkWriterFn(BigtableConfig bigtableConfig) {
        this.config = bigtableConfig;
        this.failures = new ConcurrentLinkedQueue<>();
      }
   ...
   */
  private static void checkForFailures(final ConcurrentLinkedQueue<BigtableWriteException> failures) throws IOException {
