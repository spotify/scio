...
import com.spotify.scio.bigtable.BigtableService;
import com.spotify.scio.bigtable.BigtableServiceImpl;
...
public class BigtableServiceImplTest {
  ...
  public void testWrite() throws IOException, InterruptedException {
    ...
    when(mockBulkMutation.add(any(Entry.class))).thenReturn(fakeResponse);

    underTest.writeRecord(KV.of(key, ImmutableList.of(mutation)));
    Entry expected = Entry.newBuilder()
        .setRowKey(key)
