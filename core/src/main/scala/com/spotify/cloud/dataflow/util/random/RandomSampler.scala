...
private[dataflow] abstract class RandomSampler[T, R] extends DoFn[T, T] {
 ...
 * @tparam T item type
 */
private[dataflow] class BernoulliSampler[T](fraction: Double) extends RandomSampler[T, JRandom] {
 ...
 * @tparam T item type
 */
private[dataflow] class PoissonSampler[T](fraction: Double) extends RandomSampler[T, IntegerDistribution] {
...
private[dataflow] abstract class RandomValueSampler[K, V, R](fractions: Map[K, Double]) extends DoFn[(K, V), (K, V)] {
...
private[dataflow] class BernoulliValueSampler[K, V](fractions: Map[K, Double])
...
private[dataflow] class PoissonValueSampler[K, V](fractions: Map[K, Double])
