...
class SCollectionWithSideInputTest extends PipelineTest {
  ...
  "SCollectionWithSideInput" should "support filter()" in {
    runWithContext { sc =>
      val p1 = sc.parallelize(10, 11, 12)
      val p2 = sc.parallelize(1).asSingletonSideInput
      val p3 = sc.parallelize(1, 2, 3).asIterableSideInput
      val p4 = sc.parallelize((10, 0), (11, 1), (12, 2)).asMultiMapSideInput
      ...
      s4.internal should containInAnyOrder (10, 11, 12)
    }
  }
  ...
  it should "support flatMap()" in {
    runWithContext { sc =>
      ...
      val p2 = sc.parallelize(1).asSingletonSideInput
      val p3 = sc.parallelize(1, 2, 3).asIterableSideInput
      val p4 = sc.parallelize(("a", 1), ("a", 2), ("b", 3), ("b", 4)).asMultiMapSideInput
      ...
      s4.internal should containInAnyOrder ("a8", "a9", "b10", "b11")
    }
  }
  ...
  it should "support keyBy()" in {
    runWithContext { sc =>
      ...
      val p2 = sc.parallelize(1).asSingletonSideInput
      val p3 = sc.parallelize(1, 2, 3).asIterableSideInput
      val p4 = sc.parallelize(("a", 1), ("b", 2), ("c", 3)).asMultiMapSideInput
      ...
      s4.internal should containInAnyOrder (("a8", "a"), ("b9", "b"), ("c10", "c"))
    }
  }
  ...
  it should "support map()" in {
    runWithContext { sc =>
      ...
      s4.internal should containInAnyOrder ("a8", "b9", "c10")
    }
  }
