...
final class AvroScioContext(@transient val self: ScioContext)
   ...
   */
  def avroFile[T: ClassTag: Coder](path: String,
                                   schema: Schema = null): SCollection[T] =
   ...
   */
  def protobufFile[T: ClassTag: Coder](path: String)(
    implicit ev: T <:< Message): SCollection[T] =
