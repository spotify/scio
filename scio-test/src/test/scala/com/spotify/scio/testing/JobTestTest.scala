...
object GenericParseFnAvroFileJob {
  ...
  implicit val coder: Coder[GenericRecord] =
    com.spotify.scio.coders.avro.avroGenericRecordCoder(AvroUtils.schema)
...
class JobTestTest extends PipelineSpec {
  ...
  def testGenericAvroFileJob(xs: Seq[GenericRecord]): Unit = {
    implicit val coder = com.spotify.scio.coders.avro.avroGenericRecordCoder
  ...
  def testGenericParseAvroFileJob(xs: Seq[GenericRecord]): Unit = {
    ...
    implicit val coder: Coder[GenericRecord] = com.spotify.scio.coders.avro.avroGenericRecordCoder
