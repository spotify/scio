...
final class DynamicTableRowBigQueryOps[T <: TableRow](private val self: SCollection[T])
   ...
   */
  @deprecated("use SCollectionTableRowOps.saveAsDynamicBigQueryTable instead", since = "0.10.0")
  def saveAsBigQuery(
    schema: TableSchema,
...
final class DynamicTypedBigQueryOps[T <: HasAnnotation](private val self: SCollection[T])
   ...
   */
  @deprecated("use SCollectionTypedOps.saveAsDynamicTypedBigQueryTable instead", since = "0.10.0")
